...
function pasteHTML() {
	var sHTML = "<?php echo $array['content'];?>";
...
<tr class=title>
	<td colspan=2 class=title_han align=center>&nbsp;&nbsp;글 수정</td>
</tr>

<tr valign=top>
  <td><font class=list_eng><b>제목</b></font></td>
  <td><input type=text name=subject value=<? echo $array['title'];?> id=subject size=33  maxlength=200 style=width:95% class=input></td>
</tr>
...
<tr>
  ...
  <? if ($array['s_file_name'] != '') {
			echo "<b>{$array['s_file_name']}</b> 파일이 등록되어 있습니다. "; 
			}
		?>
</tr>
...
<tr>
 ...
 <tr><td align="right">
<a href="#" onclick="pasteHTML();">불러오기</a>
<a href="#" onclick="submitContents(this);"><img src="./se/img/photoQuickPopup/btn_confirm2.png"></a>
 <a href="#" onclick="history.back();"><img src="./se/img/photoQuickPopup/btn_cancel.png"></a>
 </td></tr>
 </table>
...
function submitContents(elClickedObj) {
	...
	if(!document.getElementById("memo").value){
		...
		document.myForm.action = "./modify_ok.php?List=<?echo $list_name;?>&number=<?echo $number;?>";
