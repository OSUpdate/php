...
################파일 업로드를 위해 추가된 부분 : 끝 ######################### 
$sql = "insert into $board_name (nickname , title , content , count , ip , Date , file_name , s_file_name) values ( ? , ? , ? , ? , ? ,? , ? , ?)";
$params = array($nickname, $subject , $memo , $count , $ip , $writetime, $target, $upfile_name);
